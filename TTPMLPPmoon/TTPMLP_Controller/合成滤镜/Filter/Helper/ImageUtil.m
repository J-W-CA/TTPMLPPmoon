...
//   return [self createImageWithColor:color width: inImage.size.width height:inImage.size.height];
     return  [self addImage:inImage withImage:[self createImageWithColor:color width: inImage.size.width height:inImage.size.height] ];
}

// 颜色转图片
+ (UIImage*)createImageWithColor:(UIColor*) color width:(float)width height:(float)height {
